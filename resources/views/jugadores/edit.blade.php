    ...
    <form action="{{ route('jugadores.update', $jugador->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" name="curp" minlength="18" maxlength="18" value="{{$jugador->curp}}" placeholder="agregue CURP del jugador" required>
            </div>
        

        
            <div class="form-group col-md-4">
                <label for="goles">Goles/Canastas anotados</label>
